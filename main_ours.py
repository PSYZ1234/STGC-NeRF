...
from model.stgc_nerf import STGC_NeRF
...
def get_arg_parser():
    ...
    parser.add_argument("--workspace", type=str, default="log/kitti360_4950")
...
def main():
    ...
    model_flow.load_state_dict(checkpoint['model'], strict=opt.strict_resume)
    print('Load scene flow checkpoint: %s' % opt.resume)
