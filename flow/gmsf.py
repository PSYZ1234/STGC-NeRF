...
class GMSF(nn.Module):
    ...
    def forward(self, pc0, pc1,
        ...
        # save feat for feat constraints
        feat_preds.append(feats0_3d)
        feat_gts.append(feats1_3d)
        ...
        results_dict.update({'feat_preds': feat_preds})
        results_dict.update({'feat_gts': feat_gts})
